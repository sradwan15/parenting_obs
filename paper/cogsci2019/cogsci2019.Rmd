...
```{r e1lex_div, fig.env = "figure", fig.pos = "H", fig.align='center', fig.width=3.5, fig.height=3.1, set.cap.width=T, num.cols.cap=1, fig.cap = "Mean lexical diversity scores by condition (left: Type/Token ratio, right: MTLD) in Experiment 1."}
...
# report table with mtld_means _sds
...
```{r e1token_type, fig.env = "figure", fig.pos = "H", fig.align='center', fig.width=3.5, fig.height=3.1, set.cap.width=T, num.cols.cap=1, fig.cap = "Mean number of word types and word tokens by condition in Experiment 1."}
...
e2d <- read.csv(paste(e2path,"MTLD_HDD.csv",sep=''), header=TRUE) 
```

### Participants. 
84 infants aged 12-24 months and their parents participated in the same museum as Experiment 1. 
