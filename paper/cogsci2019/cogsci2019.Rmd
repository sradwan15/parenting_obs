...
summary(modTTR) # condition beta=-.09  t(8.7) = 3.06 p=.0141
e2TTR <- get_lmer_reporting_values(modTTR) # here, the extracted pval = .003 
...
There was suggestively lower TTR in the Video condition (mean: 0.38) than in the Control condition (mean: 0.47, $\beta=`r e2TTR["conditionexp","beta"]`$, t(8.7) = `r e2TTR["conditionexp","zval"]`, *p*=.01). 
There was no significant effect of age, nor a significant interaction.
The preregistered regression of 
A similar but exploratory mixed-effects linear regression predicting MTLD found no significant effects of age or condition.
