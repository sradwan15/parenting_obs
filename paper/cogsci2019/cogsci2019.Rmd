...
```{r fig:e1ja-pass-coord, fig.env = "figure", fig.pos = "H", fig.align='center', fig.width=3.5, fig.height=3.5, set.cap.width=T, num.cols.cap=1, fig.cap = "\\label{fig:e1ja-pass-coord} Average number of passive and coordinated episodes of JA in Experiment 1."}
...
This may suggest that parents in the Video condition end up being more repetitive in their attempt to stick to the task prescribed in the video.
...
There was a marginal interaction between RR scores and condition on passive joint attention, such that the experimental condition increased the number of episodes of passive JA to a greater extent for people with high RR scores.
...
```{r fig:e2ja, fig.env = "figure", fig.pos = "H", fig.align='center', fig.width=3.5, fig.height=3.0, set.cap.width=T, num.cols.cap=1, fig.cap = "\\label{fig:e2ja} Mean number of bids and episodes of Joint Attention in Experiment 2."}
