...
There was significantly lower TTR in the Video condition (mean: `r round(subset(e1_lexdiv, condition=='exp')$TTR, 2)`) than in the No Video condition (mean: `r round(subset(e1_lexdiv, condition=='con')$TTR, 2)`, $\beta=$`r e1TTR["conditionexp"]`, 95% CI=[`r e1TTR['95pLB']`,`r e1TTR['95pUB']`]). 
...
In contrast, the most frequent content words parents used in the No Video condition were...
