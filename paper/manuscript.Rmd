...
There was suggestively lower TTR after the Activity Video (mean: `r round(e2_lexdiv[2,]$TTR, 2)`) than after the Science Video (mean: `r round(e2_lexdiv[1,]$TTR, 2)`, $\beta=`r e2TTR["conditionexp"]`$, , 95% CI=[`r e2TTR['95pLB']`,`r e2TTR['95pUB']`]). 
