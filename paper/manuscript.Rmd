...
There was also a significant main effect of age ($\beta=`r e2tjaAge["age"]`$, 95% CI = [`r e2bidsAge["95pLB"]`,`r e2bidsAge["95pUB"]`]), showing that the number of episodes of JA decreased with the child's age. 
...
e2tja_age = ggplot(e2data, aes(x = age, y = total_ja, group=Condition, colour = Condition)) +
