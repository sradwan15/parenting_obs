...
summary(modMTLD) 
e1MTLD = get_stan_glmer_reporting_values(modMTLD, "conditionexp") # -9.19

# predict word tokens
tokens_mod <- stan_glmer(tokens ~ condition * age + (1|video), control = list(adapt_delta = 0.99), data=e1ld) 
summary(tokens_mod)
e1tokens = get_stan_glmer_reporting_values(tokens_mod, "conditionexp") # 59.41
...
There was significantly lower TTR in the Activity Video condition (mean: `r round(subset(e1_lexdiv, condition=='exp')$TTR, 2)`) than in the No Video condition (mean: `r round(subset(e1_lexdiv, condition=='con')$TTR, 2)`, $\beta=$`r e1TTR["conditionexp"]`, 95% CI=[`r e1TTR['95pLB']`,`r e1TTR['95pUB']`]). 
A similar regression instead predicting MTLD also found significantly lower lexical diversity in the Activity Video condition (mean MTLD: `r round(subset(e1_lexdiv, condition=='exp')$MTLD, 2)`) than in the No Video condition (mean: `r round(subset(e1_lexdiv, condition=='con')$MTLD, 2)`, $\beta=$`r e1MTLD["conditionexp"]`, 95% CI=[`r e1MTLD['95pLB']`,`r e1MTLD['95pUB']`]), with no other significant effects.
...
Indeed, the words identified by the corpus analysis as being words most characteristic of the activity videos were related to requests (e.g., "give", "put", "take"), whereas words characteristic of the control conditions were more invitational (e.g., "say", "let", "like").
