...
There were significantly more bids for JA in the Video condition (mean: 6.24, sd: 2.79) than in the Control condition (mean: 3.56, sd: 2.50, \(\beta=3.44\), 95\% CI={[}1.12,5.80{]}).
...
For the regression predicting the number of passive JA episodes, the only significant effect was an interaction of condition and RR (\(\beta=1.84\), 95\% CI={[}0.23,3.44{]}), showing that for parents in the Video condition, those with higher Rules and Respect subscores engaged in more passive JA episodes.
...
Shown in Figure \ref{fig:e2ja} (left panel), parents made significantly more bids for JA after watching the Activity Video (mean: 12.96, bootstrapped 95\% CI: 11.74, 14.21; \(\beta=3.06\), 95\% CI = {[}0.96,5.06{]}) than after the Science Video (mean: 9.88, 95\% CI: {[}8.71, 11.07{]}).
There were no other significant effects on parental bids for JA.

In the regression predicting the number of episodes of JA, there was a significant main effect of condition (\(\beta=1.49\), 95\% CI = {[}0.26,2.78{]}), with more episodes of JA occurring after the Activity Video (mean: 8.79, 95\% CI: {[}7.95, 9.67{]}) than after the Control Video (mean: 7.33, 95\% CI: {[}6.54, 8.05{]}).
There was also a significant main effect of age (\(\beta=-5.02\), 95\% CI = {[}-8.23,-1.41{]}), showing that the number of episodes of JA decreased with the child's age.
However, a significant interaction of age and condition (\(\beta=5.67\), 95\% CI = {[}0.50,10.71{]}), shown in the right panel of Figure \ref{fig:e2ja}, demonstrates that older children in the Activity Video condition did not see a decrease in the number of episodes of JA.
...
The regression predicting the number of episodes of coordinated JA found a significant main effect of condition (\(\beta=1.36\), 95\% CI = {[}0.16,2.58{]}), with more episodes of coordinated JA occurring after the Activity Video (mean: 6.71, 95\% CI: {[}5.90, 7.56{]}) than after the Control Video (mean: 5.34, 95\% CI: {[}4.68, 6.02{]}).
There was no significant effect of age, but there was a significant interaction of age and condition (\(\beta=5.34\), 95\% CI = {[}0.80,10.22{]}), shown in Figure \ref{fig:e2ja-coord}, revealing that older children in the Activity Video condition had more episodes of coordinated JA than children in the Control Video condition.
The regression predicting the total duration of coordinated JA episodes revealed no significant effects.

In the regression predicting the number of episodes of passive JA, there was a main effect of age (\(\beta=-2.72\), 95\% CI = {[}-5.07,0.19{]}), showing that older children had more episodes of passive JA with their caregiver.
The regression predicting the total duration of passive JA revealed a main effect of age (\(\beta=-17.70\), 95\% CI = {[}-32.73,-1.79{]}), revealing that older children spent more time in passive JA with their caregiver.
