...
```{r}
maximal_mod <- lmer(bids_tot ~ Condition *  EL  + Condition * AA + Condition * RR + age + gender +
                           (1| Video), 
                         data = lmer_data)
summary(maximal_mod)
```
...
Episodes of coordinated joint attention.
```{r}
maximal_mod <- lmer(cja ~ Condition *  EL  + Condition * AA + Condition * RR  + age + gender +
                           (1| Video), 
                         data = lmer_data)
summary(maximal_mod)
```
...
Episodes of passive joint attention.
```{r}
maximal_mod <- lmer(pja ~ Condition *  EL  + Condition * AA + Condition * RR  + age + gender +
                           (1| Video), 
                         data = lmer_data)
summary(maximal_mod)
```
...
Total duration of passive joint attention.
```{r}
maximal_mod <- lmer(pja_length ~ Condition *  EL  + Condition * AA + Condition * RR  + age + gender +
                           (1| Video), 
                         data = lmer_data)
summary(maximal_mod)
```
...
Total duration of coordinated joint attention.
```{r}
maximal_mod <- lmer(cja_length ~ Condition *  EL  + Condition * AA + Condition * RR  + age + gender +
                           (1| Video), 
                         data = lmer_data)
summary(maximal_mod)
```
